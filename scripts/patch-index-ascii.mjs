...
const enBefore = (html.match(/[A-Za-z]/g) || []).length;

if (enBefore < 800) {
  console.error("Refusing patch: English content missing", enBefore);
  process.exit(1);
}
...
console.log("Patched index.html English characters:", en, "??? blocks:", bad);
