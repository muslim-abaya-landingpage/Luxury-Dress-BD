(function () {
  ...
  function buildFooterHtml() {
    return (
      ...
      // নতুন লিঙ্কডইন আইকন যোগ করা হলো
      '<a href="' +
      esc(SOCIAL.linkedin) +
      '" target="_blank" rel="noopener" class="anz-social-link" aria-label="LinkedIn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="6" r="2"/></svg></a>' +
      // নতুন থ্রেডস আইকন যোগ করা হলো
      '<a href="' +
      esc(SOCIAL.threads) +
      '" target="_blank" rel="noopener" class="anz-social-link" aria-label="Threads"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 1a11 11 0 1 0 0 22 11 11 0 0 0 0-22zM12 5v14m-7-7h14"/></svg></a>' +
      "</div>" +
      "</div>" +
      "</div>" +
